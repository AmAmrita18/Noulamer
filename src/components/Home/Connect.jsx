            ...
            <div className='w-full flex '>
                <div className='w-[80%] h-full px-4 py-28 gap-72  mx-auto max-w-[1300px] flex '>
                    ...
                    <div className='w-[55%] flex flex-col gap-y-10' >
                        ...
                        <Link className='text-[#FFFFFF] bg-[#0A385A] w-[28%]  flex items-center  gap-3 mt-8 px-8  py-5 rounded-full font-[600] text-[17px]'>Submit <GoArrowRight className='w-6 h-6' />
                    </Link>
                        </div>
                    </div>
                </div>
