...
const GetInTouch = () => {
    return (
        <div className='w-full'>
            <div className='w-[80%]  max-w-[1300px] py-8 my-12 mx-auto'>
                        ...
                        <div className='flex flex-col gap-y-8 '>
                            <div className='flex flex-row items-center gap-4'>
                                ...
                                <div className='flex flex-col '>
                                    ...
                                    <p className='text-[19px] font-[400] text-[#1E1E1E] leading-tight'>+230 5123 4567</p>
                                </div>
                            </div>
                            <div className='flex flex-row items-center gap-4'>
                                ...
                                <div className='flex flex-col '>
                                    ...
                                    <p className='text-[19px] font-[400] text-[#1E1E1E] leading-tight'>info@noulamer.shop</p>
                                </div>
                            </div>
                            <div className='flex flex-row items-center gap-4'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <p className='text-[19px] font-[400] text-[#1E1E1E] leading-tight'>Stall Number 3, Quatre Bornes Market</p>
                                </div>
                            </div>
                        </div>
