            ...
            <div className="flex md:flex-row flex-col gap-x-16 md:gap-y-0 gap-y-4">
              <h1 className="text-[#0A385A] lg:w-[190px] md:w-[230px] w-full border-b border-[#8D8D8D] md:text-[20px] text-[16px] font-[400]">
                <input
                  ...
                  className="bg-transparent lg:w-[190px] md:w-[230px] w-full transition-all duration-700 ease-in-out  hover:scale-95 placeholder:text-[#0A385A] placeholder:text-opacity-70 outline outline-0 focus:outline-0"
                />
              </h1>
              <h1 className="text-[#0A385A] lg:w-[190px] md:w-[230px] w-full border-b border-[#8D8D8D] md:text-[20px] text-[16px] font-[400]">
                <input
